...
- Last verified implementation commit: `24bde5e` (`fix(proxy): allowlist browser-safe routes`), pushed to `main`.
- Recent commits: `24bde5e` explicit public/query proxy allowlist, `2dccfe9` same-origin public/query proxy routes, `b7397ec` all-route public privacy audit, `977856f` CI browser smoke against the public container, `15d639c` all responsive menu containment coverage.
