...
- Last verified implementation commit: `94757b5` (`fix(api): redact private stream failures`), pushed to `main`.
- Recent commits: `94757b5` SSE exception redaction, `f773b55` stream/golden regression coverage, `3cbe26e` public readiness release gate, `a7d4535` durable HITL session history.
